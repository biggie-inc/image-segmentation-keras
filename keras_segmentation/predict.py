...
def visualize_segmentation(seg_arr, inp_img=None, n_classes=None,
    ...
    cv2.putText(seg_img, f'Window Height: {window_height}', (int(xmin + 20), int(window_ymin - 8)),
                    cv2.FONT_HERSHEY_SIMPLE, .25, (0, 0, 0), 1)
    cv2.putText(seg_img, f'Window Width: {window_width}', (int(xmin + 20), int(window_ymax + 8)),
                    cv2.FONT_HERSHEY_SIMPLE, .25, (0, 0, 0), 1)
    #####
