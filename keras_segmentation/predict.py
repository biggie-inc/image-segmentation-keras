...
def visualize_segmentation(seg_arr, inp_img=None, n_classes=None,
    ...
    cv2.putText(seg_img, f'Window Height: {window_height}', (int(w_center), int(window_ymin - 5)),
                    cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 0), 1)
    cv2.putText(seg_img, f'Window Width: {window_width}', (int(w_center), int(window_ymax + 5)),
                    cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 0), 1)
    #####
